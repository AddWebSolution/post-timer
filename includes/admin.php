...
class ADDWEBPT_POST_TIMER {
  ...
  **/
  public function addweb_pt_addmenu_page() {
    add_menu_page( __( 'Post Timer', ADDWEBPT_TEXT_DOMAIN ), __( 'Post Timer', ADDWEBPT_TEXT_DOMAIN ), 'manage_options', ADDWEBPT_TEXT_DOMAIN, array( $this, 'addweb_pt_plugin_setting_page' ), '
dashicons-clock' );
  }
  /**
  * Add menu template
